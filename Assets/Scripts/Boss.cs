...
/// <inheritdoc />
/// <summary>
/// A script attached to Boss GameObject. It is responsible for handling the
...
public class Boss : MonoBehaviour {
    ...
    public int enemyScore = 1000; // The ammount of score this enemy adds when it dies
    private bool dead;
    ...
    private void Update() {
        ...
        if (animatorStateInfo.IsName("BossWalking")) {
            canShoot = true;
        }
        ...
        if (dead && animatorStateInfo.IsName("BossDeath") && animatorStateInfo.normalizedTime > 1 && !animator.IsInTransition(0)) {
    ...
    private void FixedUpdate() {
        ...
        if (nextFire < 0 && reachedStart && canShoot) {
